...
Assert-Contains $mainWindowCode 'DefaultWindowWidth = 1680' "Default GUI startup width"
Assert-Contains $mainWindowCode 'DefaultWindowHeight = 1050' "Default GUI startup height"
Assert-Contains $mainWindowCode 'ApplyInitialWindowBounds' "Initial window sizing hook"
Assert-Contains $mainWindowCode 'MoveAndResize' "Initial window centered bounds"
